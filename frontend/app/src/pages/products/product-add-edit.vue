    ...
    <q-card class="page-section q-py-sm q-px-md">
        ...
        <q-form ref="observer" @submit.prevent="submitForm()">
            ...
            <div class="col-12 row">
                <div class="col-sm-3 col-12">{{ $t("product_name") }} *</div>
            ...
            <div class="col-12 row">
                <div class="col-sm-3 col-12">{{ $t("product_rate") }} *</div>
                <div class="col-sm-9 col-12">
                    <q-input
                        v-model.trim="productFormData.rate"
                        :error="productValidate$.rate.$error"
                        :error-message="getFieldErrorsMsg(productValidate$.rate)"
                        type="number"
                    />
                </div>
            </div>
            <div class="col-12 row">
                <div class="col-sm-3 col-12">{{ $t("service_catalog_price") }} *</div>
                <div class="col-sm-9 col-12">
                    <q-input
                        v-model.trim="serviceCatalogFormData"
                        :error="serviceCatalogValidate$.price.$error"
                        :error-message="getFieldErrorsMsg(serviceCatalogValidate$.price)"
                        type="number"
                    />
                </div>
            </div>
            <div class="col-12 row">
                <div class="col-sm-3 col-12">{{ $t("service_catalog_priority") }} *</div>
                <div class="col-sm-9 col-12">
                    <q-select v-model="serviceCatalogFormData.priority" :options="serviceCatalogPriorityOptions" />
                </div>
            </div>
            <div class="col-12 row">
                <div class="col-sm-3 col-12">{{ $t("product_description") }} *</div>
                <div class="col-sm-9 col-12">

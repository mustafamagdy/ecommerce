                ...
                <div class="row col-grow">
                    <div class="col-grow column col-3">
                        <q-scroll-area class="col-grow panel q-mr-sm" visible>
                            <div class="row">
                                <div v-for="service in servicesList.records" class="col-6">
                    ...
                    <div class="col-grow column col-5">
                        <q-scroll-area class="col-grow panel q-mr-sm" visible>
                            <div class="row">
                                <div v-for="product in productsList.records" class="column col-4">
                    ...
                    <div class="column col-4 panel">
                        <div class="column col-grow items-center pos-totals text-body1">
                            ...
                            <div class="column items-center self-stretch">
                                <q-separator class="self-stretch" />
                                <div v-for="pm in paymentMethods.records" class="row no-wrap self-stretch text-h6">
...
const totalPrice = computed(() => order.items.reduce((sum, i) => sum + i.price, 0));

...
namespace System
{
  public static class ArabicFixture
  {
    ...
    public static string FixArabic(this string str, bool rtl)
    {
      if (rtl)
      {
        return FixArabic(str);
      }
      else
      {
        ...
        foreach (string word in words)
        {
          ...
          {
            result += FixArabic(arabicToIgnore) + word + " ";
            arabicToIgnore = "";
          }
          else
          {
        ...
        if (arabicToIgnore != "")
          result += FixArabic(arabicToIgnore);
    ...
    /// Use hindu numbers.
    /// </param>
    public static string FixArabic(string str, bool showTashkeel, bool useHinduNumbers)
    {
    ...
    public static string FixArabic(string str, bool showTashkeel, bool combineTashkeel, bool useHinduNumbers)
    {
      ArabicFixerTool.combineTashkeel = combineTashkeel;
      return FixArabic(str, showTashkeel, useHinduNumbers);
    }
  }
}
...
internal class ArabicFixerTool
{
  ...
  private static bool IsFinishingLetter(char[] letters, int index)
  {
    ...
    bool lettersThatCannotBeBeforeAFinishingLetter = (index != 0) && (letters[index - 1] != ' '
                                                                      && letters[index - 1] != (int)IsolatedArabicLetters.Dal
                                                                      && letters[index - 1] != (int)IsolatedArabicLetters.Thal
                                                                      && letters[index - 1] != (int)IsolatedArabicLetters.Ra2
                                                                      && letters[index - 1] != (int)IsolatedArabicLetters.Zeen
  ...
  {
    bool lettersThatCannotBeMiddleLetters = (index != 0) && (letters[index] != (int)IsolatedArabicLetters.Alef
                                                             && letters[index] != (int)IsolatedArabicLetters.Dal
                                                             && letters[index] != (int)IsolatedArabicLetters.Thal
                                                             && letters[index] != (int)IsolatedArabicLetters.Ra2
                                                             && letters[index] != (int)IsolatedArabicLetters.Zeen
    ...
    bool lettersThatCannotBeBeforeMiddleCharacters = (index != 0) && (letters[index - 1] != (int)IsolatedArabicLetters.Alef
                                                                      && letters[index - 1] != (int)IsolatedArabicLetters.Dal
                                                                      && letters[index - 1] != (int)IsolatedArabicLetters.Thal
                                                                      && letters[index - 1] != (int)IsolatedArabicLetters.Ra2
                                                                      && letters[index - 1] != (int)IsolatedArabicLetters.Zeen

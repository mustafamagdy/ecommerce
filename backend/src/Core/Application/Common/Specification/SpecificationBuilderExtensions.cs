...
public static class SpecificationBuilderExtensions
{
    ...
    ParameterExpression parameter)
  {
    ...
    var valueExpresion = GeValueExpression(field, value, propertyExpresion.Type);
  ...
  private static ConstantExpression GeValueExpression(string field, object? value, Type propertyType)
  {

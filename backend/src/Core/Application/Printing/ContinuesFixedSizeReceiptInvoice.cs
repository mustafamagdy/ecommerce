...
public class ContinuesFixedSizeReceiptInvoice : PrintableDocument
{
  private readonly OrderExportDto _model;
  private readonly IVatQrCodeGenerator _qrGenerator;
  private readonly List<IDocumentSection> _sections = new();
  ...
  public IReadOnlyCollection<IDocumentSection> Sections => _sections.AsReadOnly();
  public int Width => 3;
}
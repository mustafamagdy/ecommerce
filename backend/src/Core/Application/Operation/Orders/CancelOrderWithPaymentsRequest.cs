...
public class CancelOrderWithPaymentsRequestHandler : IRequestHandler<CancelOrderWithPaymentsRequest>
{
  ...
  public CancelOrderWithPaymentsRequestHandler(IRepositoryWithEvents<Order> repo, ISystemTime systemTime, IApplicationUnitOfWork uow)
  {
    _repo = repo;
  ...
  public async Task<Unit> Handle(CancelOrderWithPaymentsRequest request, CancellationToken cancellationToken)
  {

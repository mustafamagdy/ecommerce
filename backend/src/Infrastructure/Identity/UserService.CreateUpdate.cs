...
internal partial class UserService
{
  ...
  public async Task<UserDetailsDto> CreateAsync(CreateUserRequest request, string origin)
  {
    ...
    if (_identitySettings.RequireConfirmedAccount && !string.IsNullOrEmpty(user.Email))
    {
      ...
      var mailRequest = new MailRequest(new List<string> { user.Email }, _t["Confirm Registration"],
    ...
    var dto = user.Adapt<CreateUserResponseDto>();
    dto.CreateUserMessages = allMessages;
    return dto;
  }

...
public class HostFixture : IDisposable
{
  ...
  public HostFixture()
  {
    var db_name = "root-db";// $"main_{Guid.NewGuid()}";
    DATABASES.Add(db_name);

    _cnStringTemplate = "Data Source=127.0.0.1;Initial Catalog={0};User Id=root;Password=DeV12345;";//"SSL Mode=None;AllowPublicKeyRetrieval=true";

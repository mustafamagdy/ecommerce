...
public class LedgerEndpointsTests : TestFixture
{
    ...
    public async Task GetAccountLedger_Should_Return_Correct_Ledger_Details()
    {
        ...
        var cashAccount = await CreateAccountAsync("Cash Ledger Test", "CASHLEDGER01", AccountType.Asset, 1000m, adminHeaders); // Initial balance 1000
        ...
        await CreateAndPostJournalEntryAsync(new CreateJournalEntryRequest
        {
            ...
            Transactions = new List<CreateTransactionRequestItem>
            {
                ...
                new CreateTransactionRequestItem { AccountId = (await CreateAccountAsync("OB Contra", "OBCONTRA", AccountType.Expense, authHeaders: adminHeaders)).Id, TransactionType = "Credit", Amount = 200m }
            }
        }, adminHeaders);
        await CreateAndPostJournalEntryAsync(new CreateJournalEntryRequest
        {
            ...
            Transactions = new List<CreateTransactionRequestItem>
            {
                ...
                new CreateTransactionRequestItem { AccountId = (await CreateAccountAsync("OB Contra 2", "OBCONTRA2", AccountType.Revenue, authHeaders: adminHeaders)).Id, TransactionType = "Debit", Amount = 50m }
            }
        }, adminHeaders);
        ...
        await CreateAndPostJournalEntryAsync(new CreateJournalEntryRequest
        {
            ...
            Transactions = new List<CreateTransactionRequestItem>
            {
                ...
                new CreateTransactionRequestItem { AccountId = (await CreateAccountAsync("Period Contra 1", "PCONTRA1", AccountType.Revenue, authHeaders: adminHeaders)).Id, TransactionType = "Credit", Amount = 300m }
            }
        }, adminHeaders);
        await CreateAndPostJournalEntryAsync(new CreateJournalEntryRequest
        {
            ...
            Transactions = new List<CreateTransactionRequestItem>
            {
                ...
                new CreateTransactionRequestItem { AccountId = (await CreateAccountAsync("Period Contra 2", "PCONTRA2", AccountType.Expense, authHeaders: adminHeaders)).Id, TransactionType = "Debit", Amount = 100m }
            }
        }, adminHeaders);
        ...
        await CreateAndPostJournalEntryAsync(new CreateJournalEntryRequest
        {
            ...
            Transactions = new List<CreateTransactionRequestItem>
            {
                ...
                new CreateTransactionRequestItem { AccountId = (await CreateAccountAsync("Post Period Contra", "POSTCONTRA", AccountType.Revenue, authHeaders: adminHeaders)).Id, TransactionType = "Credit", Amount = 500m }
            }
        }, adminHeaders);
        ...
        // Act
        var response = await PostAsJsonAsync("/api/v1/accounting/ledgers/account-statement", ledgerRequest, adminHeaders);
    ...
    public async Task GetAccountLedger_Should_Return_Empty_Entries_And_Correct_Balances_For_Account_With_No_Transactions_In_Period()
    {
        // Arrange
        var (adminHeaders, _) = await CreateTenantAndLogin();
        var account = await CreateAccountAsync("No Period Trans Ledger", "NOPERIOD01", AccountType.Asset, 500m, adminHeaders); // Initial Balance 500
        ...
        await CreateAndPostJournalEntryAsync(new CreateJournalEntryRequest
        {
            ...
            Transactions = new List<CreateTransactionRequestItem>
            {
                ...
                new CreateTransactionRequestItem { AccountId = (await CreateAccountAsync("OB Contra NoPeriod", "OBCNP", AccountType.Expense, authHeaders: adminHeaders)).Id, TransactionType = "Credit", Amount = 100m }
            }
        }, adminHeaders);

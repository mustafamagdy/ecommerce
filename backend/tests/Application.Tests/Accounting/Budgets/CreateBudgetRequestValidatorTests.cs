...
public class CreateBudgetRequestValidatorTests
{
    ...
    {
        var request = new CreateBudgetRequest { BudgetName = null!, AccountId = Guid.NewGuid(), PeriodStartDate = DateTime.UtcNow, PeriodEndDate = DateTime.UtcNow.AddDays(1), Amount = 100 };
        var result = _validator.TestValidate(request);
    ...
    {
        var request = new CreateBudgetRequest { BudgetName = string.Empty, AccountId = Guid.NewGuid(), PeriodStartDate = DateTime.UtcNow, PeriodEndDate = DateTime.UtcNow.AddDays(1), Amount = 100 };
        var result = _validator.TestValidate(request);
        result.ShouldHaveValidationErrorFor(x => x.BudgetName);
    }
    ...
    {
        var request = new CreateBudgetRequest { BudgetName = new string('a', 257), AccountId = Guid.NewGuid(), PeriodStartDate = DateTime.UtcNow, PeriodEndDate = DateTime.UtcNow.AddDays(1), Amount = 100 };
        var result = _validator.TestValidate(request);
        result.ShouldHaveValidationErrorFor(x => x.BudgetName);
    }
    ...
    {
        var request = new CreateBudgetRequest { BudgetName = "Test Budget", AccountId = Guid.Empty, PeriodStartDate = DateTime.UtcNow, PeriodEndDate = DateTime.UtcNow.AddDays(1), Amount = 100 };
        var result = _validator.TestValidate(request);
    ...
    {
        var request = new CreateBudgetRequest { BudgetName = "Test Budget", AccountId = Guid.NewGuid(), PeriodStartDate = default, PeriodEndDate = DateTime.UtcNow.AddDays(1), Amount = 100 };
        var result = _validator.TestValidate(request);
    ...
    {
        var request = new CreateBudgetRequest { BudgetName = "Test Budget", AccountId = Guid.NewGuid(), PeriodStartDate = DateTime.UtcNow, PeriodEndDate = default, Amount = 100 };
        var result = _validator.TestValidate(request);
